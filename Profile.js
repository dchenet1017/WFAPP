          ...
          <MDBCol md="9" lg="7" xl="5" className="mt-5">
            <MDBCard style={{ borderRadius: '15px', backgroundColor: '#93e2bb' }}>
              <MDBCardBody className="p-4 text-black">
                <div>
                  <MDBTypography tag='h6'>Wavefinder Checkin's</MDBTypography>
                ...
                <div className="d-flex align-items-center mb-4">-
                  ...
                  <div className="flex-grow-1 ms-3">
                    <div className="d-flex flex-row align-items-center mb-2">
                      <p>Places you been to</p>
                      <p className="mb-0 me-2">@babyjesus860</p>
                      <ul className="mb-0 list-unstyled d-flex flex-row" style={{ color: '#1B7B2C' }}>
                        <li>
                        "You checked in at event 1 @5:30pm"
                          <MDBIcon fas icon="star fa-xs" />
                        </li>
                        <li>
                        "You checked in at event 2 @5:30pm"
                          <MDBIcon fas icon="star fa-xs" />
                        </li>
                        <li>
                        "You checked in at event 3 @5:30pm"
                          <MDBIcon fas icon="star fa-xs" />
                        </li>
                        <li>
                        "You checked in at event 4 @5:30pm"
                          <MDBIcon fas icon="star fa-xs" />
                        </li>
                        <li>
                        "You checked in at event 5 @5:30pm"
                          <MDBIcon fas icon="star fa-xs" />
                        </li>
                      </ul>
